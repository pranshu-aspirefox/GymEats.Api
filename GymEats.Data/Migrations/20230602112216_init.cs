        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SurplusPercentage = table.Column<int>(type: "int", nullable: false),
                    DeficitPercentage = table.Column<int>(type: "int", nullable: false),
                    MealSchedule = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResetTokenExirationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SuggesticId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MealPlanEndDate = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserBMI = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DailyActivityLevel = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MealPlanSubscriptionId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserDetails_Diet_DietId",
                        column: x => x.DietId,
                        principalTable: "Diet",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Diet_CreatedBy",
                table: "Diet",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Diet_UpdatedBy",
                table: "Diet",
                column: "UpdatedBy");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Diet_AspNetUsers_CreatedBy",
                table: "Diet",
                column: "CreatedBy",
                principalTable: "AspNetUsers",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Diet_AspNetUsers_UpdatedBy",
                table: "Diet",
                column: "UpdatedBy",
                principalTable: "AspNetUsers",
                principalColumn: "Id");
